Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(627134297039699968)
		SetDiscordRichPresenceAsset('logo')
        SetDiscordRichPresenceAssetText('Im using INFINYCTUS Server Creator!')
        SetDiscordRichPresenceAssetSmall('logo')
        SetDiscordRichPresenceAssetSmallText('Download at https://infinyctus.com')
		Citizen.Wait(60000)
	end
end)
Citizen.CreateThread(function()
